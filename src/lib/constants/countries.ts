// Lista de países para facturación. Códigos ISO 3166-1 alpha-2; los nombres se
// localizan a español con Intl.DisplayNames para no mantener un listado a mano.
const COUNTRY_CODES = [
  ...
  'PR', 'PT', 'PW', 'PY', 'QA', 'RO', 'RS', 'RU', 'RW', 'SA', 'SB', 'SC', 'SD',
  'SE', 'SG', 'SI', 'SK', 'SL', 'SM', 'SN', 'SO', 'SR', 'SS', 'ST', 'SV', 'SY',
  'SZ', 'TD', 'TG', 'TH', 'TJ', 'TL', 'TM', 'TN', 'TO', 'TR', 'TT', 'TV', 'TZ',
