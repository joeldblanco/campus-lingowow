...
export function LessonDetailsDialog({
  ...
  // Update every 30 seconds so the button appears when class time arrives
  useEffect(() => {
  ...
  // Students can only join at or after the class start time
  const classStartReached = (() => {
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <div className="flex items-center justify-between">
              <DialogTitle className="text-xl font-bold">Detalles de la Clase</DialogTitle>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {lesson.courseLevel && (
                <p className="text-sm text-muted-foreground">Nivel: {lesson.courseLevel}</p>
              )}
            </div>
              ...
              <div className="flex gap-3">
                ...
                {!isCancelled && (
                  <Button
                    ...
                    disabled={!isLive && !classStartReached}
                  >
                    ...
                    {isLive
                      ...
                      : classStartReached
                        ? 'Unirse a Clase'
                        : `Disponible a las ${lesson.startTime}`}
                  </Button>
                )}
              </div>
