                ...
                <div ref={invoiceRef} className="p-10 bg-white text-black font-sans min-h-[297mm]">
                    ...
                    <div className="flex justify-between items-start mb-10">
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-sm text-gray-600">soporte@lingowow.com</p>
                        </div>
                    </div>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="font-bold">{invoice.user.name} {invoice.user.lastName}</p>
                    ...
                    <div className="flex gap-10 mb-10">
                        <div>
                            ...
                            <p className="font-medium">{invoice.paidAt ? new Date(invoice.paidAt).toLocaleDateString() : 'Pendiente'}</p>
                        </div>
                        <div>
                            <h3 className="text-gray-500 uppercase text-xs font-semibold mb-1">Método de pago:</h3>
                    ...
                    <div className="mt-20 text-center text-xs text-gray-400">
                        ...
                        <p>Si tienes alguna pregunta sobre esta factura, contáctanos a soporte@lingowow.com</p>
                    </div>
                </div>
            </div>
        </>
