...
import { DollarSign, Users, Clock, TrendingUp, CheckCircle2, XCircle } from 'lucide-react'
...
export function PaymentSummaryCards({ summary }: PaymentSummaryCardsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {summary.totalPayableClasses} clases pagables
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Clases Pagables</CardTitle>
          <CheckCircle2 className="h-4 w-4 text-green-600" />
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">{summary.totalPayableClasses}</div>
          <p className="text-xs text-muted-foreground">
            de {summary.totalCompletedClasses} completadas
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Clases No Pagables</CardTitle>
