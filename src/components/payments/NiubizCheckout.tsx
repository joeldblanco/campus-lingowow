...
export const NiubizCheckout = ({
  ...
  const handleAuthorization = async (transactionToken: string) => {
    try {
      ...
      if (
        data.authorization &&
        data.authorization.dataMap &&
        data.authorization.dataMap.ACTION_CODE !== '000'
      ) {
  ...
  return (
    <>
      <Script src="https://static-content.vnforapps.com/v2/js/checkout.js" strategy="lazyOnload" />
