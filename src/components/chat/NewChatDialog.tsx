...
import { searchUsers, createFloatingConversation } from '@/lib/actions/floating-chat'
...
export const NewChatDialog: React.FC<NewChatDialogProps> = ({ onConversationCreated, children }) => {
                                ...
                                {results.map((user) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <p className="font-medium text-sm">{user.name} {user.lastName}</p>
